...
\hypertarget{densidad-de-los-salarios-por-kernel-no-paramuxe9trica-usando-como-kernel-biweigth}{%
\subsubsection{Densidad de los salarios por kernel (no paramétrica)
usando como kernel
Biweigth}\label{densidad-de-los-salarios-por-kernel-no-paramuxe9trica-usando-como-kernel-biweigth}}

\begin{verbatim}
## Warning in geom_density(binwidth = 150000, fill = "lightblue", color = "black",
## : Ignoring unknown parameters: `binwidth` and `freq`
\end{verbatim}
